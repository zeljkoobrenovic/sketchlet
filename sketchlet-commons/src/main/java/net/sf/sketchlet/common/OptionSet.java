 ...
 */
  ...
  public OptionSet addOption(String key) {
    return addOption(key, "");
  }

  public OptionSet addOption(String key, String description) {
    return addOption(key, defaultMultiplicity, description);
  }
 ...
 */
  ...
  public OptionSet addOption(String key, Options.Multiplicity multiplicity) {
    return addOption(key, multiplicity, "");
  }

  public OptionSet addOption(String key, Options.Multiplicity multiplicity, String description) {
    return addOption(key, false, Options.Separator.NONE, false, multiplicity, description);
  }
 ...
 */
  ...
  public OptionSet addOption(String key, Options.Separator separator) {
    return addOption(key, separator, "");
  }

  public OptionSet addOption(String key, Options.Separator separator, String description) {
    return addOption(key, false, separator, true, defaultMultiplicity, description);
  }
 ...
 */
  ...
  public OptionSet addOption(String key, Options.Separator separator, Options.Multiplicity multiplicity) {
    return addOption(key, separator, multiplicity, "");
  }

  public OptionSet addOption(String key, Options.Separator separator, Options.Multiplicity multiplicity, String description) {
    return addOption(key, false, separator, true, multiplicity, description);
  }
 ...
 */
  ...
  public OptionSet addOption(String key, boolean details, Options.Separator separator) {
    return addOption(key, details, separator, "");
  }

  public OptionSet addOption(String key, boolean details, Options.Separator separator, String description) {
    return addOption(key, details, separator, true, defaultMultiplicity, description);
  }
 ...
 */
  ...
  public OptionSet addOption(String key, boolean details, Options.Separator separator, Options.Multiplicity multiplicity) {
    return addOption(key, details, separator, multiplicity, "");
  }

  public OptionSet addOption(String key, boolean details, Options.Separator separator, Options.Multiplicity multiplicity, String description) {
    return addOption(key, details, separator, true, multiplicity, description);
  }
 ...
 */
  ...
  OptionSet addOption(String key, 
    ...
    OptionData od = new OptionData(prefix, key, details, separator, value, multiplicity, description);
    options.add(od);
    keys.put(key, od);
