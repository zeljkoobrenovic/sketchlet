...
public class Options {
    ...
    public void printUsage( String prefix ) {
        for (String setName : optionSets.keySet()) {
            ...
            for (int i = 0; i < options.size(); i++) {
                ...
                if (options.get(i).getMultiplicity() == Multiplicity.ZERO_OR_ONE) {
                    s1 = "["; s2 = "]";
                } else if (options.get(i).getMultiplicity() == Multiplicity.ZERO_OR_MORE) {
                    s1 = "{"; s2 = "}";
                } else if (options.get(i).getMultiplicity() == Multiplicity.ONCE_OR_MORE) {
                    s1 = "("; s2 = ")+";
                }


                System.out.print( s1 + "-" + options.get(i).getKey() );
                
                if (!(options.get(i).getSeparator() == Options.Separator.NONE))
                    System.out.print( options.get(i).getSeparator().getName() + "<param>" );
            ...
            System.out.println();
            System.out.println();
            if (options.size() > 0) System.out.println( "Options:" );
            
            for (int i = 0; i < options.size(); i++) {
                System.out.print( "-" + options.get(i).getKey() );
                ...
                System.out.print( "\t\t" + options.get(i).getDescription() );
                System.out.println();
            }
        }
    }
    ...
    public boolean check(String setName, boolean ignoreUnmatched, boolean requireDataLast) {
        ...
        } else if (arguments.length == 0 && this.defaultMinData == 0) {     // Options have been defined, but no arguments given
            return true;
