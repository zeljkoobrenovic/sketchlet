...
public class FileDrop {
                ...
                public void drop(java.awt.dnd.DropTargetDropEvent evt) {
                    ...
                    try {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported(java.awt.datatransfer.DataFlavor.javaFileListFlavor)) {
                            ...
                            if (listener != null) {
                                listener.filesDropped(evt.getLocation(), files);
                            }
                            ...
                            // Get a useful list
                            String strText = (String) tr.getTransferData(java.awt.datatransfer.DataFlavor.stringFlavor);
                            listener.stringDropped(evt.getLocation(), strText);
                        } else // this section will check for a reader flavor.
                        {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    if (listener != null) {
                                        listener.filesDropped(evt.getLocation(), createFileArray(br, out));
                                    }
    ...
    private boolean isDragOk(final java.io.PrintStream out, final java.awt.dnd.DropTargetDragEvent evt) {
        ...
        while (!ok && i < flavors.length) {
            ...
            if (curFlavor.equals(java.awt.datatransfer.DataFlavor.javaFileListFlavor) ||
                    curFlavor.equals(java.awt.datatransfer.DataFlavor.stringFlavor) ||
    ...
    public static interface Listener {
         ...
         * @since 1.0
         */
        public abstract void filesDropped(Point p, java.io.File[] files);

        public abstract void stringDropped(Point p, String strText);

        public abstract void dragOver(int x, int y);
