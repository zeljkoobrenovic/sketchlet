...
public class SMTPSend {
    public static void main(String[] args) {
        ...
        obj.sendMail(server, userName, fromAddres, new String[]{toAddres}, new String[]{cc}, new String[]{bcc},
                htmlFormat, secure, subject, body, null, null, null);
