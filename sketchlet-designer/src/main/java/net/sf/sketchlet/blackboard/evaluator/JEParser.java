...
public class JEParser {
    ...
    private static CellReferenceResolver resolver = new CellReferenceResolver();
    ...
    public static Object getValue(String strExpression) {
        ...
        try {
            ...
            while (e.hasMoreElements()) {
                ...
                try {
                    v.setValue(new Double(getResolver().getValue(v.getName())));
                } catch (Exception ex) {
                    String strValue = getResolver().getValue(v.getName());
                    if (strValue == null) {
                        return null;
                    }
                    v.setValue(strValue);
    ...
    public static CellReferenceResolver getResolver() {
        return resolver;
    }
}
