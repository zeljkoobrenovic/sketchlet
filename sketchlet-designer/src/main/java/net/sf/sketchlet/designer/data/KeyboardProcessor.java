...
public class KeyboardProcessor {
    Hashtable<Integer, Vector<HoldThread>> holdThread = new Hashtable<Integer, Vector<HoldThread>>();
    public java.util.List<KeyboardEventMacro> keyboardEventMacros = new ArrayList<KeyboardEventMacro>();
    ...
    public boolean processKey(final KeyEvent e, String event) {
        ...
        for (KeyboardEventMacro keyboardEventMacro : keyboardEventMacros) {
    ...
    public void dispose() {
        for (EventMacro eventMacro : keyboardEventMacros) {
            eventMacro.dispose();
        }
        keyboardEventMacros = null;
    }
