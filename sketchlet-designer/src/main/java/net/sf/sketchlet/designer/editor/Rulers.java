...
public class Rulers {
    ...
    public void drawRulers(Graphics2D g2) {
        ...
        if (SketchletEditor.editorPanel.marginX > 0 || SketchletEditor.editorPanel.marginY > 0) {
            int w = SketchletEditor.editorPanel.getWidth();
            int h = SketchletEditor.editorPanel.getHeight();
            ...
            for (int i = SketchletEditor.editorPanel.marginY; i < h + SketchletEditor.editorPanel.marginY; i += 10) {
                int x1 = 0;
                int x2 = 5;
                if (i % 20 == 0) {
                    x2 += 3;
            ...
            g2.setColor(Color.YELLOW);
            g2.drawLine(0, SketchletEditor.editorPanel.statusY + SketchletEditor.editorPanel.marginY, 8, SketchletEditor.editorPanel.statusY + SketchletEditor.editorPanel.marginY);
            /*}*/
        }
    ...
    public void calculateLimits(ActiveRegion region) {
        ...
        int mx = SketchletEditor.editorPanel.marginX;
        int my = SketchletEditor.editorPanel.marginY;
    ...
    public boolean isIn(int x, int y) {
        return x < SketchletEditor.editorPanel.marginX || y < SketchletEditor.editorPanel.marginY;
    }
    ...
    public void mouseDragged(int x, int y) {
        ...
        x -= SketchletEditor.editorPanel.marginX;
        y -= SketchletEditor.editorPanel.marginY;

        int w = SketchletEditor.editorPanel.currentPage.images != null ? SketchletEditor.editorPanel.currentPage.images[0].getWidth() : 2000;
        int h = SketchletEditor.editorPanel.currentPage.images != null ? SketchletEditor.editorPanel.currentPage.images[0].getHeight() : 2000;
