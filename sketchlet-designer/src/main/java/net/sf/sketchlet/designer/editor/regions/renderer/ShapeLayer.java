...
public class ShapeLayer extends DrawingLayer {
    ...
    public void draw(Graphics2D g2, Component component, boolean bPlayback, boolean bFill, boolean bOutline) {
        ...
        String strLineColor = region.processText(region.strLineColor);
        String strFillColor = region.processText(region.strFillColor);
        String strLineThickness = region.processText(region.strLineThickness);
        String strLineStyle = region.processText(region.strLineStyle);
        ...
        if (bFill && fillColor != null) {
            ...
            if (strShape.equalsIgnoreCase("Rectangle")) {
                ...
                if ((!strShape.isEmpty() && !strShape.equalsIgnoreCase("none")) || region.renderer.widgetImageLayer.widgetControl == null) {
