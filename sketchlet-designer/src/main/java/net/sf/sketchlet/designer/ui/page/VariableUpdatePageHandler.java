...
import net.sf.sketchlet.designer.events.hold.HoldData;
import net.sf.sketchlet.designer.events.hold.HoldProcessor;
import net.sf.sketchlet.designer.events.hold.HoldThreads;
...
public class VariableUpdatePageHandler {
    ...
    public boolean process(String variable, String value) {
        ...
        for (VariableUpdateEventMacro variableUpdateEventMacro : page.variableUpdateEventMacros) {
            ...
            var = Evaluator.processText(var, page.strVarPrefix, page.strVarPostfix);
            val = Evaluator.processText(val, page.strVarPrefix, page.strVarPostfix);

            value = DataServer.variablesServer.getVariableValue(var);
            ...
            if (!var.isEmpty() && (var.equals(variable) || vars1.contains(variable) || vars2.contains(variable))) {
                ...
                String type = Evaluator.processText(variableUpdateEventMacro.getEventName(), page.strVarPrefix, page.strVarPostfix);
