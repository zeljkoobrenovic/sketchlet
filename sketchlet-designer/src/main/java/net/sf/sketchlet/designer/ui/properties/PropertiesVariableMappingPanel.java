 ...
 */
package net.sf.sketchlet.designer.ui.properties;
...
//        final JButton edit = new JButton("Edit");
        model = new AbstractTableModel() {
            ...
            public void setValueAt(Object value, int row, int col) {
                ...
                TutorialPanel.addLine("cmd", "Set a variable mapping for " + mapping.data[row][0], "details.gif", tableScroll);
            }
        ...
        table.getColumnModel().getColumn(7).setCellEditor(new DefaultCellEditor(Curves.globalCurves.getComboBox()));
...
//        panel.add(edit);
    ...
    public void editVariableMapping(int row) {
        if (row >= 0) {
            ...
            editors[7] = DataRowFrame.cloneComboBox(Curves.globalCurves.getComboBox());
