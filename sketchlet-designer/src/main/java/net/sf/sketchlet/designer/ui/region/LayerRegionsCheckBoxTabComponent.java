...
public class LayerRegionsCheckBoxTabComponent extends JPanel {
    ...
    public LayerRegionsCheckBoxTabComponent(final JTabbedPane tabs) {
        ...
        button = new JCheckBox("", SketchletEditor.editorPanel.currentPage.isRegionsLayerActive());
        ...
        button.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                ...
                SketchletEditor.editorPanel.currentPage.bLayerRegions = button.isSelected();
                setAppearance();
