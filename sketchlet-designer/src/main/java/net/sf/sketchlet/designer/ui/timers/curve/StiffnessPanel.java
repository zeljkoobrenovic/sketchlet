...
import net.sf.sketchlet.designer.programming.timers.curves.StiffnessCurve;
...
public class StiffnessPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        curveStiffness.curve.drawCurve(g2, 50, h - 40, w - 60, h - 60);
    ...
    class MouseHandler extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            for (StiffnessSegment segment : curveStiffness.segments) {
            ...
            for (StiffnessSegment segment : curveStiffness.segments) {
                ...
                time = (mouse_x - x) / w;
                double d = Math.abs(time - segment.endTime);
                if (d > 11) {
                    StiffnessSegment newSegment = new StiffnessSegment(time, "", "");
                    curveStiffness.segments.add(newSegment);
                    curveStiffness.sort();
                    repaint();
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            curveStiffness.sort();
            frame.modelStiffness.fireTableDataChanged();
            int i = curveStiffness.segments.indexOf(selectedSegment);
            frame.tableStiffness.getSelectionModel().setSelectionInterval(i, i);
