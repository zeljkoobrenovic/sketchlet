...
public class CopyExpression {
    ...
    public String copyExpressions() {
        ...
        boolean paused = DataServer.variablesServer.paused;
        DataServer.variablesServer.paused = true;
        ...
        for (int i = start; i <= end; i++) {
            ...
            String strExp = strRowToShow.replace("<%=name%>", v.name);
            strExp = strExp.replace("<%=value%>", v.value);
            strExp = strExp.replace("<%=description%>", v.description);
        ...
        DataServer.variablesServer.paused = paused;
