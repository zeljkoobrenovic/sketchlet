...
import net.sf.sketchlet.model.events.region.ActiveRegionOverlapHandler;
...
import net.sf.sketchlet.renderer.regions.ActiveRegionRenderer;
import net.sf.sketchlet.renderer.regions.TextDrawingLayer;
...
public class ActiveRegion implements PropertiesInterface {
    ...
    // handlers
    private ActiveRegionMouseHandler mouseHandler = new ActiveRegionMouseHandler(this);
    private ActiveRegionOverlapHandler interactionHandler = new ActiveRegionOverlapHandler(this);
    private ActiveRegionMotionHandler motionHandler = new ActiveRegionMotionHandler(this);
    // images
    ...
    public ActiveRegion(ActiveRegion region, ActiveRegions actions, boolean bCopyFiles) {
        ...
        if (bCopyFiles) {
            ...
            this.getMouseHandler().setPlayback_startAngle(region.getMouseHandler().getStartAngle());
            this.getMouseHandler().setPlayback_startX(region.getMouseHandler().getStartX());
            this.getMouseHandler().setPlayback_startY(region.getMouseHandler().getStartY());
    ...
    public boolean isMouseActive() {
        return mouseProcessor.getMouseActionsCount() > 0 || movable || rotatable || !this.strWidget.isEmpty();
    }
    ...
    public void dispose() {
        ...
        if (getMouseHandler() != null) {
            getMouseHandler().dispose();
        }
        if (getInteractionHandler() != null) {
            getInteractionHandler().dispose();
        }
        if (getMotionHandler() != null) {
            getMotionHandler().dispose();
        }
    ...
    public boolean isSelected() {
        return parent.getSelectedRegions() != null && parent.getSelectedRegions().contains(this);
    }
    ...
    public int getX1() {
        return (parent != null ? parent.getOffset_x() : 0) + x1;
    }

    public int getY1() {
        return (parent != null ? parent.getOffset_y() : 0) + y1;
    }

    public int getX2() {
        return (parent != null ? parent.getOffset_x() : 0) + x2;
    }

    public int getY2() {
        return (parent != null ? parent.getOffset_y() : 0) + y2;
    }
    ...
    public void processLimitsTrajectory(Point p) {
        ...
        getMotionHandler().processLimits("trajectory position", getRenderer().getTrajectoryDrawingLayer().trajectoryPositionFromPoint, 0.0, 1.0, 0.0, 0.0, true);
        getMotionHandler().processLimits("trajectory position 2", getRenderer().getTrajectoryDrawingLayer().trajectoryPositionFromPoint2, 0.0, 1.0, 0.0, 0.0, true);
    }

    public void processLimitsX() {
        int w = this.x2 - this.x1;
        if (this.horizontalAlignment.equalsIgnoreCase("center")) {
            this.getMotionHandler().processLimits("position x", this.x1 + w / 2, w / 2, w / 2, true);
        } else if (this.horizontalAlignment.equalsIgnoreCase("right")) {
            this.getMotionHandler().processLimits("position x", this.x1 + w, w, 0, true);
        } else {
            this.getMotionHandler().processLimits("position x", this.x1, 0, w, true);
        }
    }
    ...
    public void processLimitsY() {
        ...
        if (this.verticalAlignment.equalsIgnoreCase("center")) {
            this.getMotionHandler().processLimits("position y", this.y1 + h / 2, h / 2, h / 2, true);
        } else if (this.verticalAlignment.equalsIgnoreCase("right")) {
            this.getMotionHandler().processLimits("position y", this.y1 + h, h, 0, true);
        } else {
            this.getMotionHandler().processLimits("position y", this.y1, 0, h, true);
        }
    }
    ...
    public boolean isWithinLimits(boolean bPlayback) {
        ...
        int _bx1 = (int) getMotionHandler().processLimits("position x", bx1, 0, 0, false);
        int _by1 = (int) getMotionHandler().processLimits("position y", by1, 0, 0, false);
        int _bx2 = (int) getMotionHandler().processLimits("position x", bx2, 0, 0, false);
        int _by2 = (int) getMotionHandler().processLimits("position y", by2, 0, 0, false);
    ...
    public void setDataFromPlayback() {
        if (parent == null) {
            return;
        }
        bSet = true;
        ...
        original_startAngle = getMouseHandler().getStartAngle();
        original_startX = getMouseHandler().getStartX();
        original_startY = getMouseHandler().getStartY();
        x1 = playback_x1;
        y1 = playback_y1;
        x2 = playback_x2;
        y2 = playback_y2;
        ...
        getMouseHandler().setStartAngle(getMouseHandler().getPlayback_startAngle());
        getMouseHandler().setStartX(getMouseHandler().getPlayback_startX());
        getMouseHandler().setStartY(getMouseHandler().getPlayback_startY());
    }
    ...
    public void resetFromPlayback() {
        ...
        playback_shearX = shearX;
        playback_shearY = shearY;
        getMouseHandler().setPlayback_startAngle(getMouseHandler().getStartAngle());
        getMouseHandler().setPlayback_startX(getMouseHandler().getStartX());
        getMouseHandler().setPlayback_startY(getMouseHandler().getStartY());
        ...
        getMouseHandler().setStartAngle(original_startAngle);
        getMouseHandler().setStartX(original_startX);
        getMouseHandler().setStartY(original_startY);
    }
    ...
    public ActiveRegionMouseHandler getMouseHandler() {
        return mouseHandler;
    }

    public void setMouseHandler(ActiveRegionMouseHandler mouseHandler) {
        this.mouseHandler = mouseHandler;
    }

    public ActiveRegionOverlapHandler getInteractionHandler() {
        return interactionHandler;
    }

    public void setInteractionHandler(ActiveRegionOverlapHandler interactionHandler) {
        this.interactionHandler = interactionHandler;
    }

    public ActiveRegionMotionHandler getMotionHandler() {
        return motionHandler;
    }

    public void setMotionHandler(ActiveRegionMotionHandler motionHandler) {
