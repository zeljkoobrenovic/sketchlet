...
public class HoldThreads {
    ...
    private Hashtable<String, Vector<HoldThread>> holdThreads = new Hashtable<String, Vector<HoldThread>>();
    private Vector<String> occuredEvents = new Vector<String>();
    ...
    public void stopHold(String id) {
        Vector<HoldThread> v = getHoldThreads().get(id);
        if (v != null) {
            for (HoldThread t : v) {
                t.stop();
            }
    ...
    public Hashtable<String, Vector<HoldThread>> getHoldThreads() {
        return holdThreads;
    }

    public void setHoldThreads(Hashtable<String, Vector<HoldThread>> holdThreads) {
        this.holdThreads = holdThreads;
    }
}
