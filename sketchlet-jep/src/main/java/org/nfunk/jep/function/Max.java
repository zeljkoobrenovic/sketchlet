...
public class Max extends PostfixMathCommand {
    ...
    public void run(Stack inStack) throws ParseException {
        ...
        if (this.curNumberOfParameters == 1) {
            ...
            inStack.push(max(param));//push the result on the inStack
        } else {
            Object r = inStack.pop();
            Object l = inStack.pop();
            inStack.push(max(l, r));//push the result on the inStack
        }
        return;
    }

    private Object max(Object num1, Object num2) throws ParseException {
    ...
    public Object max(Object param) throws ParseException {
