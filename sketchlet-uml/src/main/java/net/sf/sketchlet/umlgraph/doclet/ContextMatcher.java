...
public class ContextMatcher implements ClassMatcher {
    ...
    /**
     * @see net.sf.sketchlet.umlgraph.doclet.ClassMatcher#matches(com.sun.javadoc.ClassDoc)
     */
    ...
    /**
     * @see net.sf.sketchlet.umlgraph.docletClassMatcher#matches(java.lang.String)
     */
