...
/**
 * Doclet API implementation @depend - - - OptionProvider @depend - - - Options
 * @depend - - - View @depend - - - ClassGraph @depend - - - Version
 *
...
public class UmlGraph {
    ...
    private static final String docletName = "net.sf.sketchlet.umlgraph.doclet.UmlGraph";
    /**
     ...
     * @param viewRootDoc The RootDoc for the view classes (may be different, or
     * may be the same as the srcRootDoc)
     */
